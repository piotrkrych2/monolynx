...
def _feature_scrum(lang: str) -> dict[str, Any]:
    if lang == "pl":
        return {
            ...
            "ai_intro": "Agent AI może zarządzać całym cyklem Scrum: tworzyć tickety, przenosić między sprintami, dodawać komentarze, etykiety, załączniki i logować czas — 17 narzędzi MCP.",
            "mcp_tools": [
                ...
                {"name": "add_attachment", "desc": "Dodaj załącznik do ticketu (base64, max 200MB)"},
                {"name": "get_attachment", "desc": "Pobierz zawartość załącznika (base64, obrazki jako data URI)"},
                ...
                {"name": "get_activity_log", "desc": "Dziennik aktywności projektu"},
            ],
            "tech_details": [
    ...
    return {
        ...
        "ai_intro": "Your AI agent can manage the entire Scrum cycle: create tickets, move between sprints, add comments, labels, attachments, and log time — 17 MCP tools.",
        "mcp_tools": [
            ...
            {"name": "add_attachment", "desc": "Add attachment to ticket (base64, max 200MB)"},
            {"name": "get_attachment", "desc": "Get attachment content (base64, images as data URI)"},
            ...
            {"name": "get_activity_log", "desc": "Project activity log"},
        ],
        "tech_details": [
...
def _feature_wiki(lang: str) -> dict[str, Any]:
    if lang == "pl":
        return {
            ...
            "mcp_tools": [
                ...
                {"name": "update_wiki_file", "desc": "Zaktualizuj opis lub nazwę pliku"},
                {"name": "list_wiki_files", "desc": "Lista globalnych plików w repozytorium wiki"},
            ],
            "tech_details": [
                {
                    "label": "Embeddings",
    ...
    return {
        ...
        "mcp_tools": [
            ...
            {"name": "update_wiki_file", "desc": "Update file description or name"},
            {"name": "list_wiki_files", "desc": "List global files in wiki repository"},
        ],
        "tech_details": [
            {
                "label": "Embeddings",
...
def _feature_connections(lang: str) -> dict[str, Any]:
    if lang == "pl":
        return {
            ...
            "features": [
                ...
                {
                    "title": "Synchronizacja przez graphify",
                    "desc": "Zewnętrzny ekstraktor graphify (tree-sitter, 36 języków, offline) buduje graf automatycznie. Skille: create-graph-ci-script (CI) i graph-sync (lokalnie, za rękę).",
                },
            ...
            "ai_intro": "Agent AI może zbudować graf zależności Twojego kodu automatycznie i odpytywać go — 10 narzędzi MCP + bulk operacje.",
            "mcp_tools": [
                ...
                {"name": "replace_graph", "desc": "Pełna podmiana grafu projektu — idempotentny sync z ekstraktora (np. graphify)"},
    ...
    return {
        ...
        "features": [
            ...
            {
                "title": "Sync via graphify",
                "desc": "External graphify extractor (tree-sitter, 36 languages, offline) builds the graph automatically. Skills: create-graph-ci-script (CI) and graph-sync (local, guided).",
            },
        ...
        "ai_intro": "Your AI agent can build your code's dependency graph automatically and query it — 10 MCP tools + bulk operations.",
        "mcp_tools": [
            ...
            {"name": "replace_graph", "desc": "Full project graph replacement — idempotent sync from an extractor (e.g. graphify)"},
