...
```
mcp__monolynx__lint_wiki(project_slug="<PROJECT_SLUG>")
```
...
```
mcp__monolynx__append_wiki_log(project_slug="<PROJECT_SLUG>", entry="LINT: audyt zdrowia - naprawiono <co> (sieroty: N, martwe linki: M, sprzecznosci: K, luki: L)")
```
